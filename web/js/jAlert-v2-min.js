...
if(typeof thisBtn['msg']=='undefined'){thisBtn['msg']='';}
else{thisBtn['msg']=' data-msg="'+thisBtn['msg']+'"';}
...
div+="<a href='"+thisBtn['href']+"' id='"+thisBtn['id']+"' target='"+thisBtn['target']+"' class='jBtn "+thisBtn['cssClass']+"'"+thisBtn['msg']+">"+thisBtn['label']+"</a> ";});}
